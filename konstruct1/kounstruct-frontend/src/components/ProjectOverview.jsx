        ...
        <Card theme={theme} className="p-6 md:p-8">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="text-xs font-bold tracking-wide" style={{ color: subText }}>
                  {viewMode === "manager" ? "Project Overview" : "Project Head View"}
                </div>
                <div className="text-2xl md:text-3xl font-black mt-1">{projectName}</div>
                <div className="text-sm font-semibold mt-1" style={{ color: subText }}>
                  Analytics driven summary with filters, charts and drill-down views.
                </div>
                <button onClick={handleExport} className="px-3 py-2 rounded-xl text-xs font-black border">
  Export Excel
</button>


                {filtersActive && (
                  <div className="mt-3 inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-bold border"
                    style={{
                      borderColor: theme === "dark" ? "#334155" : "#e2e8f0",
                      background: theme === "dark" ? "rgba(2,6,23,0.35)" : "rgba(248,250,252,0.9)",
                      color: subText,
                    }}>
                    Filters Active • Data is recomputed
                  </div>
                )}
              </div>
            </div>
            ...
            {/* <div className="lg:text-right">
              ...
              <div className="text-4xl md:text-5xl font-black mt-1">{completionRate}%</div>
              <div className="mt-2 w-56 h-2 rounded-full overflow-hidden" style={{ background: theme === "dark" ? "#0f172a" : "#e2e8f0" }}>
                <div className="h-full" style={{ width: `${completionRate}%`, background: CHART_COLORS.success }} />
              </div>
            </div> */}
          </div>
        </Card>
