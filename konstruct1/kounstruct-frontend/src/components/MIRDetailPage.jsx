...
export default function MIRDetailPage() {
  ...
  const fetchDetail = async () => {
    try {
      ...
      setEditForm({
        ...
        stc_min_limit:
          data.stc_min_limit === null || data.stc_min_limit === undefined
            ? ""
            : String(data.stc_min_limit),
        stc_max_limit:
          data.stc_max_limit === null || data.stc_max_limit === undefined
            ? ""
            : String(data.stc_max_limit),
        inspection_min_limit:
          data.inspection_min_limit === null ||
          data.inspection_min_limit === undefined
            ? ""
            : String(data.inspection_min_limit),
        inspection_actual_value:
          data.inspection_actual_value === null ||
          data.inspection_actual_value === undefined
            ? ""
            : String(data.inspection_actual_value),
        inspection_max_limit:
          data.inspection_max_limit === null ||
          data.inspection_max_limit === undefined
            ? ""
            : String(data.inspection_max_limit),
  ...
  const handleUpdateDetails = async () => {
    ...
    const payload = {
      ...
      stc_min_limit: parseNumber(editForm.stc_min_limit),
      stc_max_limit: parseNumber(editForm.stc_max_limit),
      inspection_min_limit: parseNumber(editForm.inspection_min_limit),
      inspection_max_limit: parseNumber(editForm.inspection_max_limit),
      inspection_actual_value: parseNumber(editForm.inspection_actual_value),
                  ...
                  <td style={styles.inputCell}>
                    {isEditing ? (
                      <input
                        ...
                        value={editForm.inspection_min_limit}
                        onChange={handleEditChange}
                        style={styles.smallInput}
                      />
                    ) : (
                  ...
                  <td style={styles.inputCell}>
                    {isEditing ? (
                      <input
                        ...
                        value={editForm.inspection_actual_value}
                        onChange={handleEditChange}
                        style={styles.smallInput}
                      />
                    ) : (
                  ...
                  <td style={styles.inputCell}>
                    {isEditing ? (
                      <input
                        ...
                        value={editForm.inspection_max_limit}
                        onChange={handleEditChange}
                        style={styles.smallInput}
                      />
                    ) : (
